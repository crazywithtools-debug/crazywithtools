...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://crazywithtool.vercel.app';
...
export const metadata: Metadata = {
  ...
  keywords: ['PDF editor', 'AI content generator', 'marketing content', 'document editor', 'AI writing tool'],
  ...
  return (
    <html lang="en" data-scroll-behavior="smooth">
      <head>
        ...
        {/* AdSense placeholder: uncomment and replace with your publisher id */}
        {/* <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=pub-XXXXXXXXXXXX" crossOrigin="anonymous"></script> */}
      </head>
      <body className="min-h-screen bg-zinc-950 text-white">
        ...
        <footer className="py-4 md:py-6 text-center text-xs md:text-sm text-white/60">
          <div className="w-full max-w-7xl mx-auto px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 flex flex-col gap-2 md:gap-0 md:flex-row md:items-center md:justify-center">
            <a href="/privacy" className="underline hover:text-white/80 transition-colors mr-0 md:mr-4">Privacy</a>
            <a href="/prolevel" className="mr-0 md:mr-4 hover:text-white/80 transition-colors">Pro Level</a>
