...
export const themeColorMix = (opacity = 90) => `color-mix(in srgb, var(--theme-color), transparent ${opacity}%)`;
export const themeBoxShadow = (opacity = 60) => `0 0 0 1px var(--theme-color), 0 0 18px ${themeColorMix(opacity)}`;
